    ...
    public class JeuxPanel extends JPanel implements Runnable  {
       ...
       */
       ...
       public void paint(Graphics g ){
    	  ...
    	  g.drawString("Objectif score 50",(int)(f.getW()/10), f.getH() - 50); //Ici,on affiche l'objectif du score à atteindre.
          
          if (scoreG == 50){ //Créer la condition. Si le G atteind 50 points, alors ...
       	   
        	  g.drawString("YOU WIN",(int)(f.getW()/6/2), f.getH()/2 - 50); //... Il sera écrit qu'il a gagné.
        	  
          }
          
          if (scoreD == 50){ //Créer la condition. Si le D atteind 50 points, alors ...
    ...
    public void run() { 
          ...
          while(true){ //Boucle infinie (true)
              ...
              thread.sleep(75); //Pause de 75 millisecondes. Explications au dessus.
               ...
               if (scoreG == 50){ //Si le Guerrier atteind 10 pts
               ...
               if (scoreD == 50){ //Si le D atteind 50 pts
