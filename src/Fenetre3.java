...
public class Fenetre3 extends JFrame implements KeyListener { //Voir explications dans JeuxPanel
	
     int x = 0; //def de x
     int y = 0; //def de y

     JeuxPanel3 jeux; //Création d'une nouvelle variable
     
     public Fenetre3 (){
   	  
          setVisible(true); //Activation de la visibilité
          setTitle("Niveau 3"); //Titre fenêtre
          setBounds(x,y,500,500); //Taille fenetre
          
          jeux = new JeuxPanel3(this); //Instance jeux de la classe JeuxPanel
