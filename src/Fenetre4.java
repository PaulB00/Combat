...
public class Fenetre4 extends JFrame implements KeyListener { //Voir explications dans JeuxPanel
	
     int x = 0; //def de x
     int y = 0; //def de y

     JeuxPanel4 jeux; //Création d'une nouvelle variable
     
     public Fenetre4 (){
   	  
          setVisible(true); //Activation de la visibilité
          setTitle("Niveau 4"); //Titre fenêtre
          setBounds(x,y,500,500); //Taille fenetre
          
          jeux = new JeuxPanel4(this); //Instance jeux de la classe JeuxPanel
