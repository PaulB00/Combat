...
public class Fenetre2 extends JFrame implements KeyListener { //Voir explications dans JeuxPanel
	
     int x = 0; //def de x
     int y = 0; //def de y

     JeuxPanel2 jeux; //Création d'une nouvelle variable
     
     public Fenetre2 (){
   	  
          setVisible(true); //Activation de la visibilité
          setTitle("Niveau 2"); //Titre fenêtre
          setBounds(x,y,500,500); //Taille fenetre
          
          jeux = new JeuxPanel2(this); //Instance jeux de la classe JeuxPanel
