...
import java.io.*;
    ...
    public class JeuxPanel4 extends JPanel implements Runnable  {
    	
        Fenetre4 f; // Variable f permet d'obtenir les informations de la fenetre 
       ...
       */
       ...
       public void paint(Graphics g ){
                ...
                g.setColor(Color.gray); //Couleur du fond du jeu
            ...
            g.setColor(Color.black);//Couleur PE1
            g.fillOval(x3, y3, l, h);//Coordonnées et lg de la PE1
            
            g.setColor(Color.black);//Couleur PE2
            g.fillOval(x5, y5, l, h);//Coordonnées et lg de la PE2
            
            g.setColor(Color.red);//Couleur P2
            g.fillOval(x4, y4, l, h);//Coordonnées et lg de la P2
          ...
          if (scoreG == -1){
        	  g.drawString("La sorcière t'a tué ... SHAME",(int)(f.getW()/6/2), f.getH()/2 - 50 );
          }
          
          if (scoreD == -1){
        	  g.drawString("La sorcière a fait mourir le dragon. Pars vite pendant qu'elle est occupée !",(int)(f.getW()/6/2), f.getH()/2 - 50);
          }
      } 
    ...
    public void run() { 
          ...
          while(true){ //Boucle infinie (true)
               ...
               */ 
               ...
               if ((x == x5) && (y == y5)){ //Analyse des coordonnées
            	   
                   x5 = random.nextInt((int)(f.getW() / l)) * l ; //Choix x random pour la P2
                   y5 = random.nextInt((int)(f.getH() / l)) * l ; //Choix y random pour la P2
                   
                   scoreG-= 1; //Augmente le score
              }
               
               if ((x == x4) && (y == y4)){ //Analyse des coordonnées
            	   
                   x4 = random.nextInt((int)(f.getW() / l)) * l ; //Choix x random pour la P3
                   y4 = random.nextInt((int)(f.getH() / l)) * l ; //Choix y random pour la P3
               ...
               if ((x2 == x3) && (y2 == y3) && (scoreD > 1)){ //Analyse des coordonnées pour le D // || ((x2 == x5) && (y2 == y5))
               ...
               if ((x2 == x5) && (y2 == y5) && (scoreD>1)){
            	   
            	   x5 = random.nextInt((int)(f.getW() / l)) * l ;
            	   y5 = random.nextInt((int)(f.getH() / l)) * l ;
            	   
            	   scoreD = -1;
               }

               if ((x2 == x4) && (y2 == y4)){ //Analyse des coordonnées pour le D
            	   
                   x4 = random.nextInt((int)(f.getW() / l)) * l ; //Choix x random pour la P2
                   y4 = random.nextInt((int)(f.getH() / l)) * l ; //Choix y random pour la P2
              ...
              thread.sleep(75); //Pause de 75 millisecondes. Explications au dessus.
               ...
               if (scoreG == 15){ //Si le Guerrier atteind 15 pts
               ...
               if (scoreD == 15){ //Si le D atteind 15 pts
               ...
               if (scoreD == -1){//Si le D mange une PE
            	   
            	   wait();//Ligne 256
            	   System.exit(0);//Ligne 257
               }
               
               if (scoreG == -1){//Si le G mange une PE
            	   wait();//256
            	   System.exit(0);//257
               }
