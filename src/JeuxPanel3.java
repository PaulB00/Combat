...
import java.io.*;
    ...
    public class JeuxPanel3 extends JPanel implements Runnable  {
    	
        Fenetre3 f; // Variable f permet d'obtenir les informations de la fenetre 
       ...
       */
       ...
       public void paint(Graphics g ){
                ...
                g.setColor(Color.blue); //Couleur du fond du jeu
